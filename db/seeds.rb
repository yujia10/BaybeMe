...
yu = User.create!(first_name: "Yu", last_name: "Gu", phone_number: "0419847566", address: "02 Franklin Rd, Magill SA 3168", email: "yujiagu1010@gmail.com", password: "secret")
...
jia = Child.create!(first_name: "Jia", last_name: "Gu", gender: 1, dob: Date.new(2020,03,01), user: yu)
